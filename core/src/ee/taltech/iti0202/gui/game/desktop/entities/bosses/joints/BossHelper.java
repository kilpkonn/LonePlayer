...
public class BossHelper {
    ...
    public static void createDistanceJointBetweenLinks(Array<Boss> tempArray, float lock, float scale, World world) {
    ...
    public static void createRopeJointGEOCordBetweenLinksPlantWorm(Array<Boss> tempArray, int p, World world) {
        // create joint between bodies
    ...
    public static void createRopeJointBetweenLinks(Array<Boss> tempArray, float lock, float scale, World world) {
        // create joint between bodies

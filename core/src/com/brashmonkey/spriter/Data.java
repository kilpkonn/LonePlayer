...
/**
 * Represents all the data which necessary to animate a Spriter generated SCML file. An instance of
 * this class holds {@link Folder}s and {@link Entity} instances. Specific {@link Folder} and {@link
 * Entity} instances can be accessed via the corresponding methods, i.e. getEntity() and
 * getFolder().
 *
 * @author Trixt0r
 */

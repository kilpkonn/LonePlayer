...
/**
 * A loader is responsible for loading all resources. Since this library is meant to be as generic
 * as possible, it cannot be assumed how to load a resource. Because of this this class has to be
 * abstract. This class takes care of loading all resources a {@link Data} instance contains. To
 * load all resources an instance relies on {@link #loadResource(FileReference)} which has to
...
public abstract class Loader<R> {
    ...
    /**
     * Loads a resource. The path to the file can be resolved with {@link #root} and {@link #data}.
     * I recommend using {@link Data#getFile(FileReference)}. Then the path to the resource is
     * {@link File#name} relative to {@link #root}.
     *
    ...
    /**
     * Removes all loaded resources from the internal reference-resource map. Override this method
     * and dispose all your resources. After that call {@link #dispose()} of the super class.
     */
    public void dispose() {
        resources.clear();
        data = null;
